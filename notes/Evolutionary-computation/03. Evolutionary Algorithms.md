...
- **Population-based approach:** Maintain and evolve a group of candidate solutions.
...
- **Exploration:** Searching a wide range of possible solutions (mutation, crossover).
- **Exploitation:** Refining known good solutions (selection, reproduction).
...
- **Binary Representation** (traditionally used in genetic algorithms):
...
- **Permutation Representation:**
  - Used for ordering problems (e.g., Traveling Salesman Problem).
  - Example: `{3,1,4,2,5}`
- **Random Key Representation:**
  - Encodes solutions as random floating-point numbers.
- **Problem-Specific Representation:**
  - Custom representations for specific domains.

### 5.3 Example of Binary Representation:
A solution space mapped to binary:
```
...
Assume `x ∈ [-5, 5]` and we use a bit string of length 12, divided into three segments:
```
...
### 6.2 Crossover
- **Definition:** Combines genetic material from two parents.
- **Types:**
  - **One-Point Crossover:** Swaps genes after a single crossover point.
  - **N-Point Crossover:** Uses multiple crossover points.
...
# ii) Real-Valued Coded Evolutionary Algorithms

## 1. Pros and Cons of Binary Genetic Algorithms (GAs)

### 1.1 Advantages of Binary Coding
...
### 1.2 Disadvantages of Binary Coding
...
## 2. Real-Valued Vector Representation

### 2.1 Why Use Real-Valued Encoding?
...
## 3. Variation Operators for Real-Valued Encoding
...
# iii) Evolutionary Algorithms: Selection and Reproduction
---

## 1. Selection

### 1.1 Generic Evolutionary Algorithm
...
### 1.4 Fitness Proportional Selection
...
### 2.2 Genetic Algorithm Reproduction Strategies
